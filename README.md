...
| AZURE_DNS_LABEL | The dns name label for container group with public IP. | `jira-json-migrator` |


### Verification
Call the rest api endpoint `[AZURE_DNS_LABEL].[AZURE_LOCATION].azurecontainer.io:[PORT]/jira-json-migrator`:
```
curl http://jira-json-migrator.westeurope.westeurope.azurecontainer.io:8080/jira-json-migrator
```
